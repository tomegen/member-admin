...
class BirthdayPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.start_date_label = ctk.CTkLabel(self.date_range_frame, text="Start Date:", font=("Arial", 20, "bold"), text_color="#ffffff")
        self.start_date_label.pack(side="left", padx=10, pady=10)

        self.start_date = DateEntry(self.date_range_frame, width=12, background='darkblue', font=("Arial", 20, "bold"), text_color="#ffffff",
                                    foreground='white', borderwidth=2, date_pattern='yyyy-mm-dd')
        self.start_date.pack(side="left", padx=10, pady=10)

        # Create the end date widget
        self.end_date_label = ctk.CTkLabel(self.date_range_frame, text="End Date:", font=("Arial", 20, "bold"), text_color="#ffffff")
        self.end_date_label.pack(side="left", padx=10, pady=10)

        self.end_date = DateEntry(self.date_range_frame, width=12, background='darkblue', font=("Arial", 20, "bold"), text_color="#ffffff",
                                  foreground='white', borderwidth=2, date_pattern='yyyy-mm-dd')
        self.end_date.pack(side="left", padx=10, pady=10)


        # DateRange
        label = ctk.CTkLabel(self, text="Wähle alle Geburtstage, die kalkuliert werden sollen", font=("Arial", 20, "bold"), text_color="#ffffff")
        ...
        generate_ics_file_button = ctk.CTkButton(self, text="Erstelle Kalender (ics) Datei", font=("Arial", 20, "bold"), text_color="#ffffff", border_spacing=10, width=400,
